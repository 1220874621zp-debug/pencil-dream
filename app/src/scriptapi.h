...
public:
     ...
     *  minAlpha：低于该 alpha 的像素视为透明噪声不计入（转线稿背景的渐变
     *  灰雾 alpha 常达几十，阈值过低会把边框撑到原图大小）。 */
    Q_INVOKABLE QVariantMap keyFrameBounds(int layerIndex, int pos, int minAlpha = 64) const;
